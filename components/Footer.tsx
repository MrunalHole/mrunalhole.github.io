        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div className="text-center md:text-left">
              <h3 className="text-2xl font-bold text-white mb-2">MH</h3>
            ...
            <div className="text-center">
              ...
              <div className="flex flex-col gap-2">
                ...
                <a href="#experience" className="text-text-muted hover:text-accent-primary transition-colors text-sm">
                  Work
                </a>
                <a href="#projects" className="text-text-muted hover:text-accent-primary transition-colors text-sm">
                  Projects
                </a>
          ...
          <div className="pt-8 border-t border-white/10">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              <p className="text-text-muted text-sm text-center md:text-left">
                © {currentYear} Mrunal Hole. All rights reserved.
              </p>

              {/* Built With */}
              <p className="text-text-muted text-sm text-center md:text-right">
                Built with <span className="text-accent-primary">❤️</span> using Next.js, Tailwind CSS & Framer Motion
              </p>
            </div>
          </div>
        </div>
